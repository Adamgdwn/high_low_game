            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 gap-2">
                <button
                  ...
                  className="btn-press rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold text-slate-100 hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {authBusy ? "Working…" : "Resend Confirmation / Send Magic Link"}
                </button>
              </div>
              <div className="text-[11px] text-slate-400">
                If create account does not sign you in immediately, check inbox/spam/promotions for a confirmation email, or use the magic link button above.
              </div>
            </div>
          </div>
        </div>
